...
Point = [0,Coordinates.YCor(xloop,yloop,zloop), Coordinates.ZCor(xloop,yloop,zloop)]; 
           
           All = CartesianModelYZPlane(Point, RingStructure);
           
           SolMats.Xdir(xloop,yloop,zloop) = All.Vector(1);
           SolMats.Ydir(xloop,yloop,zloop) = All.Vector(2);
           SolMats.Zdir(xloop,yloop,zloop) = All.Vector(3); 
